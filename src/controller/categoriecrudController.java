...
public class categoriecrudController implements Initializable {
    ...
    */
    ...
    private void refreshTable() {
        ...
        List<Category> listcategory = ServiceCategoryProduit.getInstance().afficher();
    ...
    private void loadDate() {
        List<Category> listcategorie = ServiceCategoryProduit.getInstance().afficher();
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        deleteicon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            ServiceCategoryProduit rep = new ServiceCategoryProduit();
                        ...
                        editicon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/GUI/categorie.fxml"));
                            try {
                                loader.load();
...
//
    ...
    public void searchBar(KeyEvent inputMethodEvent) {
        ...
        List<Category> listcategory = ServiceCategoryProduit.getInstance().Rech("label",critera);
