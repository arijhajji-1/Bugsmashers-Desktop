...
public class PLCRUD implements Initializable {
    ...
    */
    ...
    private void refreshTable() {
        ...
        List<ProduitLouer> listproduit = ServiceProduitLouerProduit.getInstance().afficher();
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        deleteicon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            ServiceProduitLouerProduit rep = new ServiceProduitLouerProduit();
                        ...
                        editicon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/GUI/produitL.fxml"));
                            try {
                                loader.load();
...
//
    ...
    public void searchBar(KeyEvent inputMethodEvent) {
        ...
        List<ProduitLouer> listproduit = ServiceProduitLouerProduit.getInstance().Rech("nom", critera);
