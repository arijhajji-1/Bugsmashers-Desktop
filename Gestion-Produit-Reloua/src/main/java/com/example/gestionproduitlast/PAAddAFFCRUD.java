...
public class PAAddAFFCRUD implements Initializable {
    ...
    */
    ...
    private void refreshTable() {
        ...
        List<ProduitAcheter> listproduit = ServiceProduitAcheter.getInstance().afficher();
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        deleteicon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            ServiceProduitAcheter rep = new ServiceProduitAcheter();
                        ...
                        editicon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            loader.setLocation(getClass().getResource("/ProduitGUI/produitA.fxml"));
                            try {
                                loader.load();
...
//
    ...
    public void searchBar(KeyEvent inputMethodEvent) {
        ...
        List<ProduitAcheter> listproduit = ServiceProduitAcheter.getInstance().Rech("nom",critera);
