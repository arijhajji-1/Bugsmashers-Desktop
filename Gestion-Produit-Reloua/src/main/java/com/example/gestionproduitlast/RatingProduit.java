...
public class RatingProduit implements Initializable{
    ...
    public void submit(ActionEvent actionEvent) {
        if (TAdescription.getText().isEmpty()){
            ...
            //produitAcheterID=51;
            //produitLouerID=31;
            ServiceAvisProduit.getInstance().ajouter(new AvisProduit(0,produitAcheterID,produitLouerID,(int) ratingStar.getRating(),
                    LoginSession.firstName,LoginSession.email,TAdescription.getText()));
            ServiceAvisProduit sp = new ServiceAvisProduit();
            try{
