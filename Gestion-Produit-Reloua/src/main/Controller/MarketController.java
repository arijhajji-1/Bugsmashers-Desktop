...
import com.example.gestionproduitlast.ProduitL;
import com.example.gestionproduitlast.RatingProduit;
...
public class MarketController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ServiceProduitAcheter spa = new ServiceProduitAcheter();
        ...
        try {
            for (int i = 0; i < produits.size(); i++) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/ProduitGUI/item.fxml"));
    ...
    private void calculateRating(ProduitAcheter produit) {
        List<AvisProduit> lap = ServiceAvisProduit.getInstance().afficher("produit_acheter_id",produit.getId());
        ratingValue=0;
        for (AvisProduit ap:
                lap) {
    ...
    public void rateIT(ActionEvent actionEvent) {
        ...
        loader.setLocation(getClass().getResource("/ProduitGUI/ratingproduit.fxml"));
        try {
            loader.load();
